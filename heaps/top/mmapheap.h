...
private:
  ...
  class MyHeap : public LockedHeap<PosixLockType, FreelistHeap<BumpAlloc<1024 * 1024, PrivateMmapHeap>>> {
    typedef LockedHeap<PosixLockType, FreelistHeap<BumpAlloc<1024 * 1024, PrivateMmapHeap>>> SuperHeap;

  public:
    inline void *malloc(size_t sz) {
      // mesh::debug("MyHeap malloc of %zu\n", sz);
