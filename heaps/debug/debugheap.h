...
template <class Super, char freeChar = 'F', class Global = Super>
...
public:
  ...
  DebugHeap(Global *global) : Super(global) {
  }
  ...
  inline void *malloc(size_t sz) {
    ...
    size_t *canaryLocation = (size_t *)((uintptr_t)ptr + realSize - sizeof(size_t));
